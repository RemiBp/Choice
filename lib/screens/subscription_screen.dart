  ...
  Future<void> _upgradeSubscription(String newLevel) async {
    ...
    try {
      ...
      if (customerId.isEmpty) {
        ...
        // Mettre à jour l'ID client Stripe dans le profil utilisateur
        await auth.updateStripeCustomerId(customerId);
      }
    ...
    try {
      final response = await http.post(
        ...
        body: json.encode({
          ...
          'customerId': Provider.of<AuthProvider>(context, listen: false).user?.stripeCustomerId ?? '',
        }),
      );
