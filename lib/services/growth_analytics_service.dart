...
class GrowthAnalyticsService {
  ...
  Future<Map<String, dynamic>> getOverview(String producerId, {String period = '30'}) async {
    try {
      final url = Uri.parse('$baseUrl/api/growth-analytics/$producerId/overview?period=$period');
  ...
  Future<Map<String, dynamic>> getTrends(String producerId, {String period = '90'}) async {
    try {
      final url = Uri.parse('$baseUrl/api/growth-analytics/$producerId/trends?period=$period');
      final response = await http.get(url);
  ...
  Future<Map<String, dynamic>> getRecommendations(String producerId) async {
    try {
      final url = Uri.parse('$baseUrl/api/growth-analytics/$producerId/recommendations');
      final response = await http.get(url);
