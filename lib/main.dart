...
Future<void> main() async {
  ...
  final analyticsRouteObserver = AnalyticsRouteObserver(analyticsService!, navigatorKey);
  ...
  void _initializePages() {
    ...
    if (widget.accountType == 'user') {
      ...
      _pages = [
        ...
        MyProducerLeisureProfileScreen(userId: widget.userId), // Mon profil producer (restauration)
      ];
