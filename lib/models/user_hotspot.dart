...
class UserHotspot {
  ...
  factory UserHotspot.fromJson(Map<String, dynamic> json) {
    ...
    if (json['time_distribution'] != null) {
    ...
    return UserHotspot(
      ...
      zoneName: json['zone_name'] ?? 'Zone sans nom',
      intensity: (json['intensity'] is num) ? json['intensity'].toDouble() : 0.0,
      visitorCount: (json['visitor_count'] is num) ? json['visitor_count'] : 0,
...
class WeightedLatLng {
  ...
  WeightedLatLng(this.latLng, this.weight);
}